  ...
  >
    ...
    >
      <div
        ...
        :class="{
          active: item.id == snippetsStore.snippets.selectId,
          focus: item.id == snippetsStore.snippets.selectId && snippetsStore.snippets.resultFlag
        }"
      >
        <div class="result-item-focus"></div>
        <div class="result-item-info truncate">
          {{ item.content }}
        </div>
      </div>
    </section>
